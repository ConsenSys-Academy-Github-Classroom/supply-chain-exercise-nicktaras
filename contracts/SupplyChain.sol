...
contract SupplyChain {
  ...
  constructor() public {
    ...
    // yes it's needed to ensure it is not tampered with on load of this contract.
    skuCount = 0;
  }
  ...
  {
    // checkValue(); // TODO look into this.
    ...
    items[sku].buyer = msg.sender; // payable(msg.sender);
  ...
  function shipItem(uint sku) public sold(sku) seller(sku) {
  ...
  // 3. Call the event associated with this function!
  function receiveItem(uint sku) public shipped(sku) buyer(sku) {
